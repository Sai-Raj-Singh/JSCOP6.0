...
function CountdownTimer(){
   const [expiryTime, setExpiryTime] = useState("24 december 2023 13:55:25");
    ...
    return(
        <div className="row">
            ...
            {expiryTime!==false?
                ...
                :
                <>
                <button type="button" className="btn btn-outline-success">00 <sub>Days</sub></button>
                <button type="button" className="btn btn-success">:</button>
                <button type="button" className="btn btn-outline-success">00 <sub>Hours</sub></button>
                <button type="button" className="btn btn-success">:</button>
                <button type="button" className="btn btn-outline-success">00 <sub>Minutes</sub></button>
                <button type="button" className="btn btn-success">:</button>
                <button type="button" className="btn btn-outline-success">00 <sub>Seconds</sub></button>
                </>
                }
         </div>
            </div>
